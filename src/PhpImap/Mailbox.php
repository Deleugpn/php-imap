...
class Mailbox implements MailBoxInterface {
    ...
    /**
     * @param int $imapOptions
     */
    public function setImapOptions($imapOptions) {
        $this->imapOptions = $imapOptions;
    }

    /**
     * @param int $imapRetriesNum
     */
    public function setImapRetriesNum($imapRetriesNum) {
        $this->imapRetriesNum = $imapRetriesNum;
    }

    /**
     * @param array $imapParams
     */
    public function setImapParams($imapParams) {
        $this->imapParams = $imapParams;
    }

    /**
     * @param mixed $serverEncoding
     */
